...
ASZLineAttackActor::ASZLineAttackActor()
{
	...
	static ConstructorHelpers::FObjectFinder<USoundBase> FireSoundRef(TEXT("/Game/Sound/Monster/Fire.Fire"));
...
void ASZLineAttackActor::CheckDamage()
{
	...
	{ 
		...
		if (Distance <= CurrentLength && (Pawn->IsPlayerControlled()) && !(this->IsHidden()))
		{
